    ...
    if ($qtditem > $contagem) {
        ...
        while ($tbl = mysqli_fetch_array($retorno)) {
            ...
            VALUES ($valorlista,$qtditem,'$codigo_itemvenda',$idproduto,'1')";
                ...
                #SE CARRINHO JÁ EXISITIR, RETORNA O NUMERO IV_COD_IV ATIVO E INSERE MAIS ITENS NA VENDA
                ...
                $retorno = mysqli_query($link, $sqlcontarproduto2);
...
<body>
    <div class="container-global">
        ...
        <form class="formulario" action="vendas.php" method="post">
            ...
            <input type='decimal' name="qtditem" step="0.01" min="0" required oninput="this.value.replace(/[^0-9]/g, '');">
            <!-- Impede que coleque numero <0 e caracteres sem ser numericos -->
            <br>
