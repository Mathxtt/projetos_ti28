    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($cont != 0){
            ...
            try{
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'matheusteste@sapo.pt'; //coloque seu email  real
                $mail->Password = 'MatheusTeste123'; //coloque sua senha de email real
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                $mail->Port = 587; //Porta usada pelo serviço SMTP
                $mail->setFrom('matheusteste@sapo.pt', 'EMAIL REC');
                $mail->addAddress($to);
                $mail->isHTML(true);
