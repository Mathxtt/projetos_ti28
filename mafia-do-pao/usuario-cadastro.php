...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // VALIDA SE USUARIO A CADSASTRAR EXISTE
    $sql = "SELECT COUNT(usu_id) FROM tb_usuario WHERE usu_login = '$login' OR usu_email = '$email'";
    ...
    if ($contagem == 0) {
        $sql = "INSERT INTO tb_usuario(usu_login, usu_senha, usu_email, usu_status) values ('$login', '$senha', '$email', '1')";
