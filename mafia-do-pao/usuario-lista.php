...
// CONSUTA USUARIOS CADASTRADOS
$sql = "SELECT usu_login, usu_email, usu_status, usu_id FROM tb_usuario WHERE usu_status = '1'";
            ...
            ?>
                <tr>
                    ...
                    <td><a href="usuario-altera.php?id=<?= $tbl[3] ?>">
                            <input type="button" value="ALTERAR"></a></td>
